...
# Welcome!
I am a Data Scientist based in Cork, Ireland. I am currently working for [Applied Intelligence Analytics Ltd](https://www.aianalytics.ie/). My primary work involves AI research and development on EU Defence projects with topics ranging from maritime surveillence to sensor fusion. 

I was a PhD student in the [Data Science CDT](http://datascience.inf.ed.ac.uk/) at the University of Edinburgh. I have submitted my thesis and await the completion of my Viva. My research was focused on the use of similarity networks and unsupervised clustering for biomedical data. Running, bouldering and board games keep me sane when not banging my head against the monitor! 
